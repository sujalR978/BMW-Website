...
<body>
    ...
    <footer class="footer">
        ...
        <div class="footer-container">
            ...
            <div class="footer-column">
                ...
                <ul>
                    ...
                    <!-- <li><a href="learn_more.php">Booking Service</a></li> -->
        ...
        <div class="footer-theme-toggle-container">
            <button class="footer-theme-toggle-btn" id="theme-toggle-footer" aria-label="Toggle Dark Mode" title="Toggle Dark Mode">
